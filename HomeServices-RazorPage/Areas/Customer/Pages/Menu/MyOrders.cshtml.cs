...
namespace HomeServices_RazorPage.Areas.Customer.Pages.Menu
{
    ...
    public class MyOrdersModel(IOrderAppService _orderAppService
        , UserManager<AppUser> userManager
        ,IBaseDataAppService _baseDataAppService) : PageModel
    {
        [BindProperty]
        ...
        public async Task OnGet(CancellationToken cancellationToken)
        {
            ...
            ImagesPath = await _baseDataAppService.GetImagesPath(OnlineUser.Id);
        }
    }
}
